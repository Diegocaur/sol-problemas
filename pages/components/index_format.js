...
export default function Index_menu(){
    return (
            ...
            <div className="container text-center p-0 m-0" id="container">
                <div className='background-index m-0 p-0' id="background-image">
                    <div className='d-flex justify-content-center align-items-center p-5'>
                        <div className="row">
                                <div className='col-md'>
                                    <div className='card card_hover' style={{width: "20rem"}}>
